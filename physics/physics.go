...
func ABSign(v vec.Vec) bool {
	return v.Sign() == vec.Down || v.Sign() == vec.Positive || v.Sign() == vec.NegativePositive
}

func BCSign(v vec.Vec) bool {
	return v.Sign() == vec.Left || v.Sign() == vec.Negative || v.Sign() == vec.NegativePositive
}

func DCSign(v vec.Vec) bool {
	return v.Sign() == vec.Up || v.Sign() == vec.PositiveNegative || v.Sign() == vec.Negative
}

func ADSign(v vec.Vec) bool {
	return v.Sign() == vec.Right || v.Sign() == vec.PositiveNegative || v.Sign() == vec.Positive
}
